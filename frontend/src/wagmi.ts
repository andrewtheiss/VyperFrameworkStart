...
// Arbitrum Sepolia next for cheap-L2 testnet iteration; Foundry for local dev;
// mainnet last to discourage accidental use.
const chains = [sepolia, arbitrumSepolia, foundry, mainnet] as const
